/*
  ...
  Salida Serial durante prueba activa:
  speed_kmh,speed_smooth_kmh

  Flujo:
  - Espera botón
  - Al presionar botón, inicia prueba de 60 segundos
  - Durante la prueba imprime velocidad a 10 Hz
  - Al terminar, deja de imprimir
*/
...
void calibrateBaseline() {
  ...
  Serial.println("# No muevas la rueda durante la calibracion.");
...
void startTest() {
  ...
  Serial.println("speed_kmh,speed_smooth_kmh");
}
...
void setup() {
  ...
  Serial.println("# Esperando boton de inicio en GPIO23.");
  Serial.println("# Cada prueba dura 60 segundos.");
